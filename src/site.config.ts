export const siteConfig = {
  ...
  caseStudies: [
    ...
    {
      title: "High End Cocktail Lounge + Reservation System",
      result: "75% increase in table reservations within the first two months.",
      tags: ["Next.js", "Reservation System", "Stripe", "CRM Integration"],
